  ...
  return (
    <>
      ...
      >
        <div className="talent--card--background"></div>
        <div className="talent--image--wrapper">
          <img src={require(`../images/erwin.jpg`)} alt="Erwin Ibarra" />
        </div>
        <div className="talent--card--info">
          <div className="talent--card--header">
            <h4 className="talent--card--name">Erwin Ibarra</h4>
            <h4 className="talent--card--role">Front End Developer</h4>
            <h4 className="talent--card--website">
              <a
                href="https://airwhen09.github.io/ErwinIbarra/"
                className="developer--portfolio"
              >
                airwhen09.github.io/ErwinIbarra
              </a>
            </h4>
          </div>
        </div>
          ...
          <div className="talent--card--header">
            ...
            <h4 className="talent--card--website">
              <a
                ...
                className="developer--portfolio"
              >
                gianmiguel.github.io/e-Portfolio
              </a>
            </h4>
          </div>
        </div>
